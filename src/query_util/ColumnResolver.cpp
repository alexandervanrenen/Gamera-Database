...
{
   pair<uint32_t, const ColumnSchema*> result = tryFindColumn(name, tableAccessVec);
...
pair<uint32_t, const ColumnSchema*> ColumnResolver::tryFindColumn(const string& name, const vector<TableAccessInfo>& tableAccessVec)
{
