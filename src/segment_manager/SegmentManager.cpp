...
: bufferManager(bufferManager)
{
   ...
   if(isInitialSetup) {
      ...
      SegmentId spMetadataAttributesId = createSegment(SegmentType::SP, 10);
      assert(spMetadataRelationsId == kRelationsSegmentId);
      assert(spMetadataAttributesId == kAttributesSegmentId);
   } else {
