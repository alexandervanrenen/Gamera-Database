...
public:
   ...
   /// variables
   void add(const std::string& identifier, Value&& value);
   void update(const std::string& identifier, Value&& value);
...
private:
   Environment* parent;
   std::vector<std::pair<std::string, Value>> data; // variables
