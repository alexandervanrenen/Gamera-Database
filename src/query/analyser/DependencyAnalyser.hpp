...
public:
   ...
   std::unique_ptr<qopt::GlobalRegister> createGlobalRegister(std::vector<std::pair<std::string, std::unique_ptr<harriet::Expression>>>& selectors, std::vector<std::unique_ptr<harriet::Expression>>& conditions);
