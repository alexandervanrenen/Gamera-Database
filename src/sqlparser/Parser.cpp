   ...
   switch(state) {
      ...
      case State::AttributeName:
         if (tok==keyword::Integer) {
            schema.relations.back().attributes.back().type=AttributeType::Integer;
            state=State::AttributeTypeInt;
         } else if (tok==keyword::Char) {
            schema.relations.back().attributes.back().type=AttributeType::Char;
            state=State::AttributeTypeChar;
         } else if (tok==keyword::Numeric) {
            //schema.relations.back().attributes.back().type=AttributeType::Numeric;
